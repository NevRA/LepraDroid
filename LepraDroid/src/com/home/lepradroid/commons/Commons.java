...
public class Commons
{
    ...
    public static final String WEBVIEW_POST_HEADER   
                                                = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><script type=\"text/javascript\">function getWidth(id, src){try{document.getElementById(id).src = ImageResizer.getImageUrl(src);}catch(e){}}</script>";
    public static final String WEBVIEW_COMMENT_HEADER
                                                = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><script type=\"text/javascript\">function getWidth(id, src, num){try{document.getElementById(id).src = ImageResizer.getImageUrl(src, num);}catch(e){}}</script>";
