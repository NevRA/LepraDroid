 ...
 * </ul>
 */
public abstract class WorkerTask<Params, Progress, Result> {
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new AsyncTaskResult<Result>(WorkerTask.this, (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new AsyncTaskResult<Result>(WorkerTask.this, result));
                message.sendToTarget();
            }
        };
    }
    ...
    private static class AsyncTaskResult<Data> {
        @SuppressWarnings("rawtypes")
        final WorkerTask mTask;
        final Data[] mData;

        AsyncTaskResult(@SuppressWarnings("rawtypes") WorkerTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
